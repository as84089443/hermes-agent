...
**On this machine, prefer the shared dispatcher instead of raw `opencli`:**

```bash
/Users/brian/.openclaw/scripts/browser-cli.sh opencli <site> <command> [options]
```

This dispatcher ensures the browser bridge stack is ready first:
- `opencli daemon`
- real `Google Chrome` keepalive bridge
- CDP connection health

## Syntax

```bash
/Users/brian/.openclaw/scripts/browser-cli.sh opencli <site> <command> [--option value] [-f json]
```
...
```bash
# 读取/浏览
/Users/brian/.openclaw/scripts/browser-cli.sh opencli bilibili hot --limit 10 -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli zhihu hot -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli weibo hot -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli twitter timeline -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli hackernews top --limit 20 -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli v2ex hot -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli reddit hot -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli xiaohongshu feed -f json

# 搜索
/Users/brian/.openclaw/scripts/browser-cli.sh opencli bilibili search --keyword "AI" -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli zhihu search --keyword "大模型" -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli twitter search --query "claude AI" -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli youtube search --query "LLM tutorial" -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli boss search --query "AI工程师" --city "上海" -f json

# 互动（写操作）
/Users/brian/.openclaw/scripts/browser-cli.sh opencli twitter post --text "Hello from CLI!"
/Users/brian/.openclaw/scripts/browser-cli.sh opencli twitter reply --url "https://x.com/.../status/123" --text "Great post!"
/Users/brian/.openclaw/scripts/browser-cli.sh opencli twitter like --url "https://x.com/.../status/123"

# 个人数据
/Users/brian/.openclaw/scripts/browser-cli.sh opencli bilibili history -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli twitter bookmarks -f json
/Users/brian/.openclaw/scripts/browser-cli.sh opencli xueqiu watchlist -f json
```
...
```
1. /Users/brian/.openclaw/scripts/browser-cli.sh opencli <site> --help  →  报错？说明不支持
2. /Users/brian/.openclaw/scripts/browser-cli.sh opencli generate <url>  →  尝试自动生成（成功则结束）
3. 自动生成失败 → 手动创建 YAML：
   a. 用 Playwright 打开目标页面
   b. browser_evaluate 探索 DOM 结构（找 data-test 属性、class 规律）
   c. 确认选择器后写入 ~/.opencli/clis/<site>/top.yaml
   d. /Users/brian/.openclaw/scripts/browser-cli.sh opencli <site> top -f json  →  验证输出
```
